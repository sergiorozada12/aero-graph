...
from utils import load_df_from_raw_files, cast_df_raw_columns, filter_airports, get_time_vars, get_label
...
df_filt, od_pairs = filter_airports(df_casted)
...
df_complete = get_time_vars(df_merged, dates, hours, od_pairs).drop(columns=['MONTH'], inplace=True)
